...
class Condicion(models.Model):
    ...
    area_m2 = models.DecimalField(max_digits=7,decimal_places=1, null=False, default=0)
    area_hectareas=models.DecimalField(max_digits=7,decimal_places=1, null=False, default=0)
...
class Predio(models.Model):
    ...
    total_anotaciones=models.IntegerField(null=True)
